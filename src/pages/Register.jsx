...
<div className='mb-3'>
                ...
                <div className='mb-3'>
                    ...
                    <input type="email" name='email' placeholder='Enter your Eamil' className='shadow-sm bg-white appearance-none border rounded
                    w-full py-2 px-3  text-gray-700 leading-tight focus:outline-none
                    focus:shadow-outline' />
                </div>

                <div className='mb-3'>
                    <label htmlFor="type" className='block text-gray-700 text-sm mb-2'>
                        Buyer/Seller
                    </label>
                    <input type="text" name='type' placeholder='Please Enter' className='shadow-sm bg-white appearance-none border rounded
                    w-full py-2 px-3  text-gray-700 leading-tight focus:outline-none
                    focus:shadow-outline' />
                </div>
                ...
                mx-auto text-center mb-3 mt-5'  type='submit'>Sign In
                </button>
