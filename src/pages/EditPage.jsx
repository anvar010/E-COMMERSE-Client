...
function EditPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        const productImage = image?.url || productDetails.productImage;

        // Check if any field is empty or category is not selected
        if (!name || !price || !category || !stock || !location || !description || !productImage || category === "") {
            toast.error("Please fill in all fields and upload an image, and select a category.");
            return;
        }
    ...
    return (
        <div className='addproduct'>
            <div className='w-full mx-auto pt-[16vh]'>
                <h1 className="text-3xl font-bold text-gray-800 mb-5 text-center white-red-text">Edit <span className='text-[#f54748]'> Product
                </span> Details</h1>
